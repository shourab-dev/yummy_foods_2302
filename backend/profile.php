                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="../controller/passwordUpdate.php" method="POST">
                            ...
                            <input name="oldPsk" placeholder="Old Password" type="text" class="form-control">
                            <span class="text-danger"><?= $_SESSION['errors']['oldPsk'] ?? "" ?></span>
                            <input name="psk" placeholder="New Password" type="text" class="form-control">
                            <span class="text-danger"><?= $_SESSION['errors']['psk'] ?? "" ?></span>
                            <input name="confirmPsk" placeholder="Confirm Password" type="text" class="form-control">
